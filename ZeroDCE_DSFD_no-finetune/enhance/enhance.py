...
# project
from enhance.exposure_enhancement import enhance_image_exposure
...
parser.add_argument("-f", '--folder', default='./image/', type=str,
...
def lowlight_enhance(image):
    return enhance_image_exposure(image, args.gamma, args.lambda_, not args.lime,
                                  sigma=args.sigma, bc=args.bc, bs=args.bs, be=args.be, eps=args.eps)