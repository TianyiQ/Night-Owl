...
mv ./val_test9.txt ./val.txt

mv ./wider_face_val.mat ./wider_face_val_real.mat
mv ./wider_face_val_test9.mat ./wider_face_val.mat

mv ./wider_face_split/wider_face_val.mat ./wider_face_split/wider_face_val_real.mat
mv ./wider_face_split/wider_face_val_test9.mat ./wider_face_split/wider_face_val.mat

mv ./ground_truth/wider_face_val.mat ./ground_truth/wider_face_val_real.mat
mv ./ground_truth/wider_face_val_test9.mat ./ground_truth/wider_face_val.mat
